  ...
  return (
    <>
      <section className="grid max-w-screen-4xl py-10 mt-14 mx-auto text-white">
        <h1 className="text-white font-sf inline-block font-medium text-3xl md:text-4xl xl:text-5xl">
          Well Your Search Is Over!
        </h1>
        <p className="text-gray-300 text-sm lg:text-base font-roboto py-2">
          Winkiz connects creators and brands on one powerful platform — where
        ...
        <div className="grid items-center justify-center gap-14 lg:gap-8 xl:gap-0 py-16 md:grid-cols-12">
          ...
          <div className="mr-auto place-self-center md:col-span-6 relative">
            <h1 className="max-w-4xl mb-4 text-[#F5ADB2] text-left text-3xl font-normal md:text-4xl xl:text-5xl relative">
              Winkiz
            </h1>
            <div className="flex flex-col items-start gap-4 md:gap-0">
              <p className="text-left text-gray-300 text-lg lg:text-2xl md:w-10/12 py-2 font-roboto">
                ...
                time. That’s exactly where Winkiz comes in.
              </p>
