        ...
        <div className="grid max-w-screen-4xl px-4 py-8 mx-auto gap-14 lg:gap-8 xl:gap-0 lg:py-16 md:grid-cols-12">
          <div className="mr-auto place-self-center md:col-span-7 relative">
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-8">
              <p className="text-left text-gray-300 text-lg lg:text-xl md:w-7/12">
                Find your next project, partner, or client — all in one platform.
              </p>
              <span className="md:flex md:items-center md:justify-center">
                <div className="flex gap-4">
                  ...
                  <button
                    ...
                    className="bg-[#EFAC16] hover:bg-[#F5ADB2] w-26 text-sm md:w-auto flex items-center justify-center md:text-base font-medium text-center text-gray-900 py-2 px-3 mt-4 rounded-bl-3xl rounded-t-3xl focus:ring-1 focus:ring-gray-100"
                  >
                    For Brands
                  </button>
                </div>
