...
function TestimonialCard({ name, quote, profilePic, borderColor }) {
  return (
    <div className={`text-white w-[260px] md:w-[529px] h-auto md:h-[302px] border-[10px] font-roboto rounded-tr-[80px] rounded-bl-[80px] rounded-tl-[10px] rounded-br-[10px] border-[${borderColor}] p-6`}>
      <div>
