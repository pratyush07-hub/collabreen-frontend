    ...
    return (
        <div className="min-h-screen mt-16 bg-gray-50 p-4 sm:p-8">
            <div className="max-w-2xl mx-auto">
                <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 sm:mb-6">Edit Your Creator Profile</h1>
                <p className="text-gray-600 mb-6 sm:mb-8">Update your details to keep your profile fresh and relevant.</p>
